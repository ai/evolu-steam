...
evoplus.steam.Runner = function(driver, count) {
    ...
    this.ready(function() {
        for (var i = 0; i < this._optionsAfterInit.length; i++) {
            this.option.apply(this, this._optionsAfterInit[i])
        }
        for (var i = 0; i < this._getAfterInit.length; i++) {
            this.get.apply(this, this._getAfterInit[i])
        }
    })
}
evoplus.steam.Runner.prototype = {
    ...
    /**
     * Options, which was be set before all workers was initialized. Them
     * will be send to workers by ready listener.
     */
    _optionsAfterInit: [],
    
    /**
     * Get requests, which was be set before all workers was initialized. Them
     * will be send to workers by ready listener.
     */
    _getAfterInit: [],
    ...
    option: function(name, value) {
        if (!this.isInitialized()) {
            this._optionsAfterInit.push([name, value])
            return this
        }
    ...
    get: function(name, callback) {
        if (!this.isInitialized()) {
            this._getAfterInit.push([name, callback])
            return this
        }
